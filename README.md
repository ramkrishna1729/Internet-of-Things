...
4. Data Publish and subscribe using Message Queue Telemetry Transport ( MQTT )and uploading data to thinkspeak Iot cloud
5. Data publish and subscribe using Hyper Text transmission Protocol ( HTTP ) and uploading data to thinkspeak Iot cloud
